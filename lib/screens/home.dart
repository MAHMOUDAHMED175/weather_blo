  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) =>
          WeatherCubit()..getWeatherData(city_Name: city_Name),
      child:
                              ...
                              Expanded(
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        '   ${cubit?.location!.name}         ${cubit?.location!.country}',
                                        style: TextStyle(
                              ...
                              Row(
                                children: [
                                  Container(
                                    ...
                                    child: Image(
                                      image: cubit?.forecast!.forecastday![0]
                                                  .day!.condition!.icon !=
                                              null
                                          ? NetworkImage(
                                              'http:${cubit?.forecast!.forecastday![0].day!.condition!.icon}')
                                          : AssetImage(
                                                  "${WeatherCubit.get(context).getImage()}")
                                              as ImageProvider,
                                    ),
                                  ),
                                  SizedBox(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              '${cubit?.forecast!.forecastday![0].day!.maxtempC!.ceil()}',
                                              style: TextStyle(
                                                fontSize: MediaQuery.of(context)
                                                        .size
                                                        .width /
                                            ...
                                            Text(
                                              '/${cubit?.forecast!.forecastday![0].day!.mintempC!.floor()}',
                                              style: TextStyle(
                                                fontSize: MediaQuery.of(context)
                                                        .size
                                                        .width /
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text(
                                          '${cubit?.forecast!.forecastday![1].day!.maxtempC!.ceil()}',
                                          style: TextStyle(
                                            fontSize: MediaQuery.of(context)
                                                    .size
                                                    .width /
                                        ...
                                        Text(
                                          '${cubit?.forecast!.forecastday![2].day!.maxtempC!.ceil()}',
                                          style: TextStyle(
                                            fontSize: MediaQuery.of(context)
                                                    .size
                                                    .width /
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text(
                                          '${cubit?.forecast!.forecastday![0].day!.mintempC!.ceil()}',
                                          style: TextStyle(
                                            fontSize: MediaQuery.of(context)
                                                    .size
                                                    .width /
                                        ...
                                        Text(
                                          '${cubit?.forecast!.forecastday![1].day!.mintempC!.ceil()}',
                                          style: TextStyle(
                                            fontSize: MediaQuery.of(context)
                                                    .size
                                                    .width /
                                        ...
                                        Text(
                                          '${cubit?.forecast!.forecastday![2].day!.mintempC!.ceil()}',
                                          style: TextStyle(
                                            fontSize: MediaQuery.of(context)
                                                    .size
                                                    .width /
